...
function Cta() {
  return (
    <div className="bg-[url('/backgrounds/cta.png')] flex py-20 flex-col items-center justify-center text-center bg-cover bg-no-repeat bg-center ">
      <h2 className="text-white text-[4rem]  font-medium leading-[1.2] mx-[6%]">
        Join the community of
        <span className="text-[#fcb017]  font-cabin">12,000+</span>
        authors
        <br />& become the best-seller
      </h2>
      <p className="text-white font-poppins mt-5 text-[1.5rem] w-[50%]">
        Call
